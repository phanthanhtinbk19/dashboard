...
<form action="{{" /admin/update-project/$project->id"}}" name="demoform2" id="demoform2" method="POST" class="dropzone"
    enctype="multipart/form-data">
    @csrf
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Edit New Project</h2>
    ...
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <input name="title" value="{{$project->title}}" type="text" class="intro-y form-control py-3 px-4 box pr-10"
                placeholder="Title">
                ...
                <div class="project__content tab-content">
                    <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                            ...
                            <div class="mt-5">
                                <textarea name="" id="hint" cols="30" rows="10" hidden>{{$project->desc}}</textarea>
        ...
        <div class=" col-span-12 lg:col-span-4">
            <div class="intro-y box p-5">
                ...
                {{-- <div class="mt-3">
                    <label for="project-form-3" class="form-label">City</label>
                    <select id="city" name="city" data-placeholder="Select kind" class="tom-select w-full">
                        <option disabled selected>Tỉnh/Thành</option>
                    </select>
                </div>
                <div class="mt-3">
                    <label for="project-form-3" class="form-label">District</label>
                    <select id="district" name="district" class="w-full">
                        <option disabled style="font-size: 14px" selected>Huyện/Xã</option>
                    </select>

                </div>
                <div class="mt-3">
                    <label for="project-form-3" class="form-label">Ward</label>
