...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <button class="btn btn-primary shadow-md mr-2">
            <a href="{{'/admin/add-employee'}}">Add New Employee</a>
        </button>
        <div class="dropdown">
                ...
                <tr class="intro-x">
                    ...
                    <td class="w-40">
                        <div class="w-12 h-12 image-fit zoom-in">
                            @if ($employee->avatar)
                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{url("uploads/employees/$employee->avatar")}}" title="Uploaded at {{$employee->created_at}}">
                            >
                            @else
                            <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{url("https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/User_icon_2.svg/800px-User_icon_2.svg.png")}}"
                                title="Uploaded at {{$employee->created_at}}">
                            >
                            @endif
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3" href="{{('edit-employee/'.$employee->id)}}">
                                <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                            </a>
                            <a class="flex items-center text-danger btn-delete" href="javascript:;"
                                employee_id="{{$employee->id}}" data-tw-toggle="modal"
...
<script>
    $(document).ready(function () {
        $('.btn-delete').click(function () {
            ...
            $('#delete-confirmation-modal-employee').find('a').attr('href', url + employee_id);
        });
    });
</script>
