...
<form role="form" action="{{('/admin/save-employee')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-6 2xl:col-span-6">
                                    <div>
                                        ...
                                        <input value="{{$employee->name}}" name="name" id="update-profile-form-1"
                                ...
                                <div class="col-span-6 2xl:col-span-6">
                                    <div>
                                        ...
                                        <input name="email" id="update-profile-form-1" value="{{$employee->email}}"
                                ...
                                <div class="col-span-6 2xl:col-span-6">
                                    <div class="mt-3">
                                        ...
                                        <input name="phone" value="{{$employee->phone}}" id="update-profile-form-1"
                                            type="text" class="form-control" placeholder="Input text">
                                    </div>
                                </div>
                                <div class="col-span-6 2xl:col-span-6">
                                    <div class="mt-3">
                                        ...
                                        <select name="position" id="Kind" class="form-select">
                                            <option value="Nhân viên viết nội dung">Nhân viên viết nội dung</option>
                                ...
                                <div class="col-span-12">
                                    <div class="mt-3">
                                        ...
                                        <textarea name="address" id="update-profile-form-5" class="form-control"
                                            placeholder="Adress">{{$employee->address}}</textarea>
                                    </div>
                                </div>
                            </div>
