...
<form role="form" action="{{('/admin/save-account')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                ...
                                <div class="col-span-6 2xl:col-span-6">
                                    <div>
                                        ...
                                        <input name="email" id="update-profile-form-1" type="email" class="form-control"
                                            placeholder="email">
                                    </div>
                                </div>
                                <div class="col-span-6 2xl:col-span-6">
                                ...
                                <div class="col-span-6 2xl:col-span-6">
                                    <div class="mt-3">
                                        ...
                                        <input name="phone" id="update-profile-form-1" type="number"
