                                ...
                                <div class="col-span-12 2xl:col-span-6">
                                    <div>
                                        ...
                                        <input name="name" id="update-profile-form-1" type="text" class="form-control"
                                            placeholder="Input text" value="{{ $account->name }}">
                                    </div>
                                </div>
                                <div class="col-span-12 2xl:col-span-6">
                                    <div class="mt-3">
                                        <label for="update-profile-form-6" class="form-label">Email</label>
                                        <input name="email" id="update-profile-form-6" type="text" class="form-control"
                                            placeholder="Input text" value="{{ $account->email }}">
                                    </div>
                                </div>
                                <div class="col-span-12 2xl:col-span-6">
                                    <div class="mt-3">
                                        ...
                                        <input name="phone" id="update-profile-form-4" type="text" class="form-control"
                                            placeholder="Input text" value={{$account->phone}}>
                                    </div>
                                </div>
                                <div class="col-span-12 2xl:col-span-6">
                                    <div class="mt-3">
